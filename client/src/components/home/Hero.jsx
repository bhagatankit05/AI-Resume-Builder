            ...
            <div className="min-h-screen pb-20 bg-[#0f0f11] text-white">
                ...
                <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
                    <a href="https://prebuiltui.com">
                        <img src="/logo.svg" alt="logo" className="h-11 w-auto brightness-200" /></a>

                    <div className="hidden md:flex items-center gap-8 transition duration-500 text-gray-300">
                    ...
                    <div className="flex gap-2">
                        ...
                        <Link
                            to="/app?state=login"
                            className="hidden md:block px-6 py-2 border border-gray-600 active:scale-95 hover:bg-gray-800 transition-all rounded-full text-gray-300 hover:text-white"
                        >
                            Login
                        </Link>
                    </div>
                ...
                {/* Mobile Menu */}
                <div
                    className={`fixed inset-0 z-[100] bg-black/80 text-white backdrop-blur flex flex-col items-center justify-center text-lg gap-8 md:hidden transition-transform duration-300 ${menuOpen ? 'translate-x-0' : '-translate-x-full'
                        }`}
                >
                ...
                <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-white">
                    <div className="absolute top-28 xl:top-10 -z-10 left-1/4 size-72 sm:size-96 xl:size-120 2xl:size-132 bg-indigo-800 blur-[100px] opacity-40"></div>
                    ...
                    <div className="flex items-center mt-24">
                        <div className="flex -space-x-3 pr-3">
                            <img
                                ...
                                alt="user3"
                                className="size-8 object-cover rounded-full border-2 border-gray-900 hover:-translate-y-0.5 transition z-[1]"
                            />
                            <img
                                src="https://images.unsplash.com/photo-1633332755192-727a05c4013d?q=80&w=200"
                                alt="user1"
                                className="size-8 object-cover rounded-full border-2 border-gray-900 hover:-translate-y-0.5 transition z-2"
                            />
                            <img
                                src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?q=80&w=200"
                                alt="user2"
                                className="size-8 object-cover rounded-full border-2 border-gray-900 hover:-translate-y-0.5 transition z-[3]"
                            />
                            <img
                                src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?q=80&w=200"
                                alt="user3"
                                className="size-8 object-cover rounded-full border-2 border-gray-900 hover:-translate-y-0.5 transition z-[4]"
                            />
                            <img
                                src="https://randomuser.me/api/portraits/men/75.jpg"
                                alt="user5"
                                className="size-8 rounded-full border-2 border-gray-900 hover:-translate-y-0.5 transition z-[5]"
                            />
                        </div>
                                ...
                                {Array(5)
                                    ...
                                    .map((_, i) => (
                                        <svg
                                            ...
                                            className="lucide lucide-star text-transparent fill-indigo-500"
                                            aria-hidden="true"
                                        >
